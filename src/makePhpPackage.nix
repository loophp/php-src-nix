        ...
        packageOverrides = finalPO: prevPO: {
          extensions = prevPO.extensions // {
            intl = prevPO.extensions.intl.overrideAttrs (attrs: {
              buildInputs =
                if (lib.majorMinor prevPO.php.version "8.1" && lib.versionOlder prevPO.php.version "8.1.22") || (lib.majorMinor prevPO.php.version "8.2" && lib.versionOlder prevPO.php.version "8.2.9") then
